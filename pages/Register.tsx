...
const Register: React.FC = () => {
  ...
  const handleGoogleRegister = () => {
    ...
    if (result.success) {
        alert("Simulasi: Pendaftaran Google Berhasil (Akun Demo)");
        navigate('/admin');
    }
  };
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[60vh] animate-fade-in space-y-8">
      <div className="text-center space-y-2">
        <h1 className="text-3xl font-serif font-bold text-zinc-900 dark:text-zinc-50">Bergabung</h1>
        <p className="text-zinc-600 dark:text-zinc-400">Mulai menulis cerita Anda di Taman Digital.</p>
      </div>
